...
def simulationstep():
    global x, y, q,Q ,cntOld, distS0Old ,distS2Old
...
for cnt in range(100000):
    ...
    #####################
    if cnt-cntOld==1000 or distS2 != distS2Old or distS0 != distS0Old :
        cntOld=cnt
        distS0Old=distS0
        distS2Old=distS2
        # Pick-up state randomly
        current_state = distS2
        print(Q)
        ...
        TD = reward[current_state, next_state] + gamma * Q[next_state, np.argmax(Q[next_state,])] - Q[
